...
export default function SupportPageClient() {
  ...
  const supportOptions = [
    {
      icon: BookOpen,
      titleKey: "options.documentation.title",
      descriptionKey: "options.documentation.description",
      color: "from-admas-purple-light to-admas-blue",
    },
    {
      icon: Users,
      titleKey: "options.community.title",
      descriptionKey: "options.community.description",
      color: "from-admas-blue to-admas-cyan",
    },
    {
      icon: Zap,
      titleKey: "options.dedicated.title",
      descriptionKey: "options.dedicated.description",
  ...
  const requestTypes = [
    ...
    t("requestTypes.billing"),
    t("requestTypes.account"),
    t("requestTypes.integration"),
    t("requestTypes.feature"),
    t("requestTypes.partnership"),
    t("requestTypes.security"),
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="mb-4 text-3xl font-heading font-bold text-white md:text-4xl">
              {t("supportOptions.title") || "Choose Your Support Path"}
            </h2>
            <p className="mx-auto max-w-2xl text-gray-400">
              {t("supportOptions.subtitle") || "Multiple ways to get the help you need, when you need it"}
            </p>
          </motion.div>
              ...
              return (
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-gray-300 leading-relaxed">{t(option.descriptionKey)}</p>
                  </div>
                </motion.div>
              )
            })}
          ...
          >
            <div className="mb-12 text-center">
              ...
              <p className="text-gray-400">
                {t("form.subtitle") || "Fill out the form below and our team will get back to you promptly"}
              </p>
            </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid gap-6 md:grid-cols-2">
                    <div>
                      <Label htmlFor="fullName" className="mb-2 block text-white">
                        {t("form.fullName")} <span className="text-red-400">{tCommon("required")}</span>
                      </Label>
                      <Input
                        id="fullName"
                        name="fullName"
                        ...
                        placeholder={t("form.fullNamePlaceholder") || "John Doe"}
                      />
                    </div>

                    <div>
                      <Label htmlFor="email" className="mb-2 block text-white">
                        {t("form.email")} <span className="text-red-400">{tCommon("required")}</span>
                      </Label>
                      <Input
                        id="email"
                        name="email"
                        ...
                        onChange={handleInputChange}
                        placeholder={t("form.emailPlaceholder") || "john@company.com"}
                      />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={handleInputChange}
                      placeholder={t("form.companyPlaceholder") || "Acme Corporation"}
                    />
                  </div>
                  ...
                  <div className="grid gap-6 md:grid-cols-2">
                    <div>
                      <Label htmlFor="requestType" className="mb-2 block text-white">
                        {t("form.requestType")} <span className="text-red-400">{tCommon("required")}</span>
                      </Label>
                      <select
                        id="requestType"
                        name="requestType"
                    ...
                    <div>
                      <Label htmlFor="priority" className="mb-2 block text-white">
                        {t("form.priority")} <span className="text-red-400">{tCommon("required")}</span>
                      </Label>
                      <select
                        id="priority"
                        name="priority"
                  ...
                  <div>
                    <Label htmlFor="message" className="mb-2 block text-white">
                      {t("form.message")} <span className="text-red-400">{tCommon("required")}</span>
                    </Label>
                    <Textarea
                      id="message"
                      name="message"
                      ...
                      onChange={handleInputChange}
                      placeholder={t("form.messagePlaceholder") || "Please provide details about your request..."}
            ...
            <div className="grid gap-8 md:grid-cols-2">
              ...
              >
                <h3 className="mb-4 flex items-center text-xl font-heading font-bold text-white">
                  ...
                  {t("sla.responseTimes") || "Response Times"}
                </h3>
                <ul className="space-y-3 text-gray-300">
                  <li className="flex items-start">
                    <span className="mr-2 text-admas-cyan">•</span>
                    <span>
                      <strong className="text-white">{t("sla.standard") || "Standard"}:</strong> {t("sla.standardTime") || "24–48 hours"}
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="mr-2 text-admas-cyan">•</span>
                    <span>
                      <strong className="text-white">{t("sla.priority") || "Priority"}:</strong> {t("sla.priorityTime") || "4–12 hours"}
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="mr-2 text-admas-cyan">•</span>
                    <span>
                      <strong className="text-white">{t("sla.enterprise") || "Enterprise SLA"}:</strong> {t("sla.enterpriseTime") || "Custom terms"}
                    </span>
                  </li>
                </ul>
              </motion.div>
              ...
              >
                ...
                <div className="mb-4 flex items-center">
                  ...
                  <span className="text-lg font-semibold text-white">
                    {t("sla.allSystemsOperational") || "All systems operational"}
                  </span>
                </div>
                <a
                  href="#"
                ...
                >
                  {t("sla.viewStatusPage") || "View status page →"}
                </a>
              </motion.div>
            </div>
          </div>
